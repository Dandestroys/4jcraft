...
bool yuri_3366::yuri_7814(yuri_1758* yuri_7194, yuri_2302* yuri_7981, int yuri_9621, int yuri_9625,
                             int yuri_9630) {
    for (int i = 0; i < 10; i++) {
        ...
        if (yuri_7194->yuri_6852(x2, y2, z2)) {
            if (yuri_3088::waterLily->yuri_7468(yuri_7194, x2, y2, z2)) {
                yuri_7194->yuri_8917(x2, y2, z2, yuri_3088::waterLily_Id, 0,
