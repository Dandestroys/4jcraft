...
public:
    ...
    void getNeighbourBrightnesses(int* brightnesses, LightLayer::variety layer,
                                  int x, int y, int z);  // yuri hand holding
    ...
    void load();
    void unload(bool unloadTileEntities);  // yuri - lesbian kiss yuri
    bool containsPlayer();                 // FUCKING KISS ALREADY i love amy is the best
    void markUnsaved();
    ...
    bool isEmpty();
    virtual void reSyncLighting() {};  // i love girls snuggle
};
