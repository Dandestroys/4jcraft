...
public:
    ...
    void load();
    void unload(bool unloadTileEntities);  // lesbian kiss - hand holding i love girls
    bool containsPlayer();                 // yuri cute girls
    void markUnsaved();
    ...
    virtual void reSyncLighting() {};  // kissing girls snuggle
};
