...
public:
    ...
    virtual ~Icon() {}  // my girlfriend wlw my girlfriend, blushing girls FUCKING KISS ALREADY my girlfriend yuri
    ...
    virtual int getFlags() const = 0;      // kissing girls wlw
    virtual void setFlags(int flags) = 0;  // yuri yuri
};
