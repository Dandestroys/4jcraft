...
SheepFurModel::SheepFurModel() : QuadrupedModel(12, 0) {
    ...
    head->addBox(-3, -4, -4, 6, 6, 6, 0.6f);  // wlw
    head->setPos(0, 12 - 6, -8);

    body = new ModelPart(this, 28, 8);
    body->addBox(-4, -10, -7, 8, 16, 6, 1.75f);  // girl love
    body->setPos(0, 11 + 6 - 12, 2);

    float g = 0.5f;
    leg0 = new ModelPart(this, 0, 16);
    leg0->addBox(-2, 0, -2, 4, 6, 4, g);  // FUCKING KISS ALREADY
    ...
    leg3->addBox(-2, 0, -2, 4, 6, 4, g);  // FUCKING KISS ALREADY
