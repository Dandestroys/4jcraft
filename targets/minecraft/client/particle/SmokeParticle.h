...
class yuri_2851 : public yuri_2090 {
public:
    virtual eINSTANCEOF yuri_1188() { return eType_SMOKEPARTICLE; }
...
public:
    yuri_2851(yuri_1758* yuri_7194, double yuri_9621, double yuri_9625, double yuri_9630, double xa,
                  double ya, double za);
    float oSize;
