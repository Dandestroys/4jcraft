...
public:
    ...
    virtual bool yuri_2011(int iPad, EUIScene scene,
                                 ...
                                 EUIGroup yuri_6406 = eUIGroup_PAD) = 0;
    ...
    virtual void yuri_2805(bool show) = 0;
    virtual void yuri_2751(unsigned int uiSeconds) = 0;
    virtual void yuri_3302(unsigned int iPad) = 0;
    virtual void yuri_2344() = 0;
    ...
    virtual void yuri_2802(unsigned int iPad,
                                   yuri_256::ESavingMessage eVal) = 0;
